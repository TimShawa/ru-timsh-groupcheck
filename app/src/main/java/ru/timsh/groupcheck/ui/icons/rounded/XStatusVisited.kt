...
val AppIcons.Rounded.XStatusVisited: ImageVector
    get() {
        if (_XStatusVisited != null) {
            return _XStatusVisited!!
        }
        _XStatusVisited = ImageVector.Builder(
            name = "Rounded.XStatusVisited",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            viewportHeight = 960f
...
private var _XStatusVisited: ImageVector? = null

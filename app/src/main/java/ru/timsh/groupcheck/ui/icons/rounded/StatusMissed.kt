...
val AppIcons.Rounded.StatusMissed: ImageVector
    get() {
        if (_StatusMissed != null) {
            return _StatusMissed!!
        }
        _StatusMissed = ImageVector.Builder(
            name = "Rounded.StatusMissed",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            viewportHeight = 960f
...
private var _StatusMissed: ImageVector? = null
